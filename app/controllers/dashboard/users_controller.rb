class Dashboard::UsersController < Dashboard::BaseController
  ...
  def user_params
    params.require(:user).permit(:name, :email, :password, :password_confirmation, :subdomain, :custom_domain, :blog_title, :light_theme, :dark_theme, :site_meta_description, :favicon_emoji)
  end
end
