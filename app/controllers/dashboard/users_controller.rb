class Dashboard::UsersController < Dashboard::BaseController
  ...
  def user_params
    params.require(:user).permit(:name, :email, :password, :password_confirmation, :subdomain, :custom_domain, :blog_title, :theme, :site_meta_description, :favicon_emoji, :post_footer_markdown, :no_index)
  end
end
